...
export const totalMaxPrice = {
  ...
  placeholder: "Total Max Price",
  queryName: "maximum_price",
}
export const totalMinPrice = {
  totalMinimumPrice: [
    {
      name: "No min",
      value: "10000",
  ...
  placeholder: "Total Min Price",
  queryName: "minimum_price",
}

export const minPricePerMonth = {
  totalMinimumPrice: [
    {
      name: "No min",
      value: "10000",
  ...
  placeholder: "Minimum Price per month",
  queryName: "minimum_price",
}

export const maxPricePerMonth = {
  totalMaximumPrice: [
    {
      name: "No max",
      value: "10000",
